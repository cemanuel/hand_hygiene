...
def get_filenames_and_labels_of_images_from_path(path):
    ...
    if os.path.isfile(path):
        with gfile.GFile(path, mode="r") as path_file:
            for line in path_file:
                filename_of_image, label_of_image = line.strip().split(",")
                filenames_of_images.append(filename_of_image)
                labels_of_images.append(label_of_image)
    return filenames_of_images, labels_of_images
...
def prepare_data(data_path):
    """
        ...
        #################################################################################################################
    """
    filenames_of_images, labels_of_images = get_filenames_and_labels_of_images_from_path(data_path)
    return filenames_of_images, labels_of_images
